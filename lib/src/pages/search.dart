...
import 'package:flutter_instagram/src/pages/search/search_focus.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        child: Column(
          children: [
            _appbar(), // 상단 고정이 아닌 앱바 사용을 위해 Scaffold 의 appBar 대신 사용
      ...
      children: [
        Expanded(
          child: GestureDetector(
            onTap: () {
              // Get.to(const SearchFocus()); // bottom navigator 유지 위해 사용 X
              Navigator.push(
                context,
